...
const zhCN = {
  ...
  updates: {
    ...
    relaunchingTitle: "正在重新启动",
    relaunchingDescription: "更新已安装，DataNexa 即将重新启动。",
    checkFailedTitle: "暂时无法检查更新",
    checkFailedDescription: "请检查网络连接后稍后重试，当前版本不会受到影响。",
...
const en: I18nMessages = {
  ...
  updates: {
    ...
    relaunchingTitle: "Restarting DataNexa",
    relaunchingDescription: "The update is installed and DataNexa is about to restart.",
    checkFailedTitle: "Unable to check for updates",
    checkFailedDescription: "Check your network connection and try again later. Your current version is unaffected.",
