...
const zhCN = {
  ...
  toast: {
    ...
    jdbcRuntimeInstalled: "DataNexa Runtime 已安装。",
    jdbcRuntimeUpdateAvailable: "发现 DataNexa Runtime 新版本 {version}。",
    jdbcRuntimeUpToDate: "DataNexa Runtime 已是最新版本。"
  },
  overview: {
    loading: "正在加载本地工作区...",
  ...
  settings: {
    ...
    jdbcRuntimeStorage: "JDBC Runtime 占用",
    ...
    jdbcRuntimeDescription: "首次使用 JDBC 时下载 DataNexa Java Runtime，也可以手动选择外部 Runtime。",
    runtimeAvailable: "可用",
    runtimeUnavailable: "不可用",
    runtimeNotDetected: "未检测到 Java Runtime",
    runtimeChecking: "正在检查 JDBC 运行环境...",
    runtimeSource: "来源：{source}",
    runtimeSourceManaged: "DataNexa Runtime",
    runtimeSourceEmbedded: "旧版内置 Runtime",
    runtimeSourceExternal: "外部 Runtime",
    runtimeSourceUnavailable: "不可用",
    selectJavaRuntime: "选择外部 Runtime",
    useManagedRuntime: "使用 DataNexa Runtime",
    installJdbcRuntime: "下载 DataNexa Runtime",
    checkJdbcRuntimeUpdate: "检查 Runtime 更新",
    ...
    clearMavenCache: "清除 Maven 缓存",
    clearMavenCacheConfirmTitle: "清除 Maven 缓存？",
    clearMavenCacheConfirmDescription: "这会删除 maven-repository 中已下载的依赖。下次安装 JDBC 驱动时会重新下载，已安装驱动、审计日志和配置不会受影响。",
    confirmClearMavenCache: "确认清除缓存",
    ...
    jdbcRiskCompatibility: "驱动、Java Runtime、JDBC URL、认证信息或网络参数不兼容，可能导致连接失败、SQL 报错、连接中断或请求超时。",
...
const en: I18nMessages = {
  ...
  settings: {
    ...
    jdbcRuntimeDescription: "Download the DataNexa Java Runtime when JDBC is first used, or select an external Runtime manually.",
    ...
    clearMavenCache: "Clear Maven cache",
    clearMavenCacheConfirmTitle: "Clear the Maven cache?",
    clearMavenCacheConfirmDescription: "This removes downloaded dependencies from maven-repository. JDBC dependencies will be downloaded again when needed; installed drivers, audit logs, and configuration are not affected.",
    confirmClearMavenCache: "Clear cache",
