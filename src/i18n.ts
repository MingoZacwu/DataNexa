...
const zhCN = {
  ...
  settings: {
    ...
    allowed: "允许执行",
    denied: "已拒绝",
    securityPosture: "安全姿态",
    securityAst: "SQL AST 策略校验",
    securityVault: "凭证保存到 OS 凭证库",
    securityAudit: "审计日志不记录查询结果",
    securityReadonly: "默认只读会话和限额",
...
const en: I18nMessages = {
  ...
  settings: {
    ...
    securityAst: "SQL AST policy validation",
    securityVault: "Credentials saved to the OS vault",
    securityAudit: "Audit logs do not store query results",
    securityReadonly: "Read-only sessions and limits by default",
