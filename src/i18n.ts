...
const en: I18nMessages = {
  ...
  settings: {
    ...
    jdbcRuntimeDescription: "DataNexa uses its bundled Java Runtime by default. An external Runtime is used only after you select it explicitly.",
