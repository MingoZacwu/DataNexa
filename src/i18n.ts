...
const zhCN = {
  ...
  overview: {
    ...
    callsUnit: "次",
    callsTruncatedHint: "审计记录展示数量已达上限，实际调用次数可能更多。",
    running: "运行中",
    stopped: "已停止",
    failed: "启动失败",
  ...
  tools: {
    ...
    names: {
      ...
      system_auto_circuit_breaker: "自动熔断"
    },
    intros: {
  ...
  settings: {
    ...
    clearDebugLogsOption: "调试日志",
    selectedSpace: "预计释放空间",
    confirmClearJdbcCache: "清理并释放空间",
    cacheAllClean: "当前很干净，暂无可清理的缓存。",
    ...
    auditRetentionDaysOption: "{days} 天",
    auditPrivacy: "日志隐私",
    ...
    denied: "已拒绝",
    security: "安全",
    securityWarning: "DataNexa 数据安全防护仅作为风险缓解措施，不能完全保证所有风险操作都被拦截，仍需约束 Agent，避免要求或允许其执行危险行为。",
    securityBlockedLabel: "过去 24 小时拦截",
    securityBlockedUnit: "次",
    securityBlockedTruncatedHint: "审计日志展示数量已达上限，实际拦截次数可能更多",
    securityViewAudit: "查看审计日志",
    securityDefenseActive: "全链路数据安全防护已启用",
    securityDefensePartial: "全链路数据安全防护未完全启用",
    securityLayerNetwork: "网络",
    securityLayerNetworkDesc: "仅监听本机回环地址，严格 CSP 与 Host/Origin 校验",
    securityLayerAuth: "认证",
    securityLayerAuthDesc: "Bearer 密钥默认开启，支持免重启手动轮换",
    securityLayerAuthOffDesc: "Bearer 密钥认证未开启，建议前往连接设置开启",
    securityLayerAuthOffBadge: "未启用",
    securityLayerSyntax: "语法",
    securityLayerSyntaxDesc: "AST 级校验，拒绝 DDL/DML/SELECT INTO 与副作用函数",
    securityLayerDatabase: "数据库",
    securityLayerDatabaseDesc: "SQLite 只读打开，MySQL/PostgreSQL 启用只读事务",
    securityLayerResource: "资源",
    securityLayerResourceDesc: "行数、超时、连接池、结果大小与速率限额",
    securityLayerAudit: "审计",
    securityLayerAuditDesc: "本地审计日志，支持 SQL 字面量脱敏与自动裁剪",
    circuitBreaker: "访问令牌自动熔断",
    circuitBreakerToggle: "开启自动熔断",
    circuitBreakerToggleHint: "同一访问令牌在统计窗口内触发拦截达到阈值后，自动停用该令牌",
    circuitBreakerWindow: "统计窗口",
    circuitBreakerWindowOption: "{minutes} 分钟",
    circuitBreakerThreshold: "拦截次数阈值",
    circuitBreakerThresholdOption: "{count} 次",
    circuitBreakerNote: "熔断后令牌将自动停用并写入审计日志，可在“访问控制”中手动重新启用。",
    circuitBreakerRequiresBearer: "自动熔断依赖 Bearer 访问令牌鉴权，请先在“通用 → 服务策略”中启用。",
    aboutText: "本地只读数据库 MCP 网关，让 Agent 通过统一、安全、可审计的入口访问你的数据源。",
    officialHomepage: "官方主页",
    debugLogging: "启用调试日志",
    debugLoggingTooltip: "记录运行日志用于问题排查，包含脱敏后的错误信息",
    debugLogConfirmTitle: "启用调试日志？",
    debugLogConfirmDescription: "调试日志用于问题排查，日常使用时建议保持关闭。继续前请确认你了解以下影响。",
    debugLogConfirmTroubleshootOnly: "调试日志仅用于问题排查，日常使用时无需开启。",
    debugLogConfirmPerformance: "开启后应用会在后台持续写入日志文件，可能对性能产生轻微影响。",
    debugLogConfirmSanitized: "日志内容已经过脱敏处理，不会记录明文凭据。",
    debugLogConfirmEnable: "仍然开启",
    openDebugLogFolder: "打开日志文件夹",
  },
  updates: {
    readyTitle: "应用更新",
    ...
    runtimeUpdateTitle: "Java 运行时更新",
    runtimeUpdateCompact: "{version} 可用",
...
const en: I18nMessages = {
  ...
  overview: {
    ...
    callsUnit: "time(s)",
    callsTruncatedHint: "The audit log display reached its cap. The actual call count may be higher.",
    running: "Running",
    stopped: "Stopped",
  ...
  tools: {
    ...
    names: {
      ...
      system_auto_circuit_breaker: "Auto circuit breaker"
    },
    intros: {
  ...
  settings: {
    ...
    storageCategoryLogs: "Debug logs",
    ...
    clearDebugLogsOption: "Debug logs",
    selectedSpace: "Estimated space to free",
    confirmClearJdbcCache: "Clear and free space",
    cacheAllClean: "Everything looks clean — there is no cache to clear.",
    ...
    auditRetentionDaysOption: "{days} days",
    ...
    denied: "Denied",
    security: "Security",
    securityWarning: "DataNexa data protection serves only as a risk mitigation measure and cannot guarantee every risky operation is blocked. Constrain agents and avoid asking or allowing them to perform dangerous actions.",
    securityBlockedLabel: "Blocked in last 24h",
    securityBlockedUnit: "times",
    securityBlockedTruncatedHint: "Audit log display reached its cap; the actual blocked count may be higher",
    securityViewAudit: "View audit log",
    securityDefenseActive: "Full-chain data protection enabled",
    securityDefensePartial: "Full-chain data protection partially enabled",
    securityLayerNetwork: "Network",
    securityLayerNetworkDesc: "Listens on loopback only, with strict CSP and Host/Origin checks",
    securityLayerAuth: "Authentication",
    securityLayerAuthDesc: "Bearer token on by default, with no-restart rotation",
    securityLayerAuthOffDesc: "Bearer token auth is off. Enable it in Connection settings",
    securityLayerAuthOffBadge: "Off",
    securityLayerSyntax: "Syntax",
    securityLayerSyntaxDesc: "AST validation rejects DDL/DML and side-effect functions",
    securityLayerDatabase: "Database",
    securityLayerDatabaseDesc: "SQLite opened read-only; MySQL/PostgreSQL read-only transactions",
    securityLayerResource: "Resource",
    securityLayerResourceDesc: "Row, timeout, pool, size and rate limits on every query",
    securityLayerAudit: "Audit",
    securityLayerAuditDesc: "Local audit logs with SQL literal redaction and auto-trim",
    circuitBreaker: "Token auto circuit breaker",
    circuitBreakerToggle: "Enable auto circuit breaker",
    circuitBreakerToggleHint: "Auto-disable a token once it hits the denial threshold within the counting window",
    circuitBreakerWindow: "Counting window",
    circuitBreakerWindowOption: "{minutes} minutes",
    circuitBreakerThreshold: "Denial threshold",
    circuitBreakerThresholdOption: "{count} times",
    circuitBreakerNote: "A tripped token is auto-disabled with an audit event; re-enable it manually in Access Control.",
    circuitBreakerRequiresBearer: "The circuit breaker requires bearer token authentication. Enable it first under General → Service Policy.",
    ...
    debugLoggingTooltip: "Record runtime logs for troubleshooting, with sanitized error messages",
    debugLogConfirmTitle: "Enable debug logging?",
    debugLogConfirmDescription: "Debug logging is meant for troubleshooting and is best kept off in daily use. Confirm that you understand the impact before continuing.",
    debugLogConfirmTroubleshootOnly: "Debug logging is intended for troubleshooting only and is unnecessary in daily use.",
    debugLogConfirmPerformance: "While enabled, the app keeps writing log entries in the background, which may slightly affect performance.",
    debugLogConfirmSanitized: "Log content is sanitized and never records plaintext credentials.",
    debugLogConfirmEnable: "Enable anyway",
    openDebugLogFolder: "Open log folder",
  },
  updates: {
    ...
    runtimeUpdateTitle: "JRE update available",
    runtimeUpdateCompact: "{version} available",
